export default function Carousel() {
  ...
  return (
    <>
      <swiper-container className="mySwiper md:w-calka z-40 h-[40px] bg-white block"
        scrollbar-hide="true" space-between="0"
        centered-slides="true" autoplay-delay="2500"
        autoplay-disable-on-interaction="false">
        <swiper-slide><div className="text-center z-40  w-full text-black flex justify-center items-center h-full">
