export default function Hero() {
    return (
        <>
            <div className="h-fit w-full flex-col justify-center items-center">
                <div className="">
                    <h1 className="text-3xl underline">
                        <b>Tienda de Comida:</b>
                    </h1>
                    <p
                        className="text-sm max-w-[450px]"
                    >
                        Cocinamos con el corazón, seleccionando solo los ingredientes más frescos y de la más alta calidad. Nuestro menú está inspirado en lo mejor de la cocina internacional, con un toque distintivo que transforma cada comida en un momento memorable.
                    </p>
                </div>
